...
BEGIN {
    ...
    require '/Users/nick/eudora-carbon/XcodeSupport/Generated/OpenSSL/darwin-i386/work/src/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/nick/eudora-carbon/XcodeSupport/Generated/OpenSSL/darwin-i386/work/src/test/fips-and-base.cnf';
    shift;
...
if ($ARGV[0] eq '-jitter') {
    $std_openssl_conf = '/Users/nick/eudora-carbon/XcodeSupport/Generated/OpenSSL/darwin-i386/work/src/test/default-and-jitter.cnf';
    shift;
